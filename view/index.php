    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <img class="img-fluid w-75" src="../assets/img/logo_transp2.png" alt="page_logo">
        </div>;
      </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <?php
            ...
            foreach ($produtos as $produto) {
              ...
              echo "
                <div class='col-lg-4 col-md-6 portfolio-item filter-{$produto->getCategoria()}'>
                  <div class='portfolio-wrap'>
                    <img src='../assets/img/products/{$produto->getNome()}-1.png' class='img-fluid' alt=''>
                    <div class='portfolio-info'>
                      <h4>{$produto->getNome()}</h4>
                      <p>{$produto->getDescricao()}</p>
                      <p>R$ {$produto->getPreco()}</p>
                      <div class='portfolio-links'>
                        <a href='../assets/img/products/{$produto->getNome()}-1.png' data-gallery='portfolioGallery' class='portfolio-lightbox' title='{$produto->getNome()}'><i class='bx bx-plus'></i></a>
                      </div>
                    </div>
                  </div>
                </div>";
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="../assets/img/denis.jpg" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="../assets/img/gabriel.jpg" class="testimonial-img" alt="">
                <h3>Gabriel David</h3>
                <h4>Frontend</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
